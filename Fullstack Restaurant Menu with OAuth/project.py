...
def gdisconnect():
	...
	background_pic='<img src="https://www.omnihotels.com/-/media/images/hotels/bospar/restaurants/bospar-omni-parker-house-parkers-restaurant-1170.jpg">'
	if access_token is None:
		output='<h2>Current user not connected.</h2>'
		output+='<br><a href="/restaurant">Go back Main Page</a>'
		output+='<br>'
		output+=background_pic
		return output
	...
	if result['status'] == '200':
		...
		output='<h2>Successfully disconnected.</h2>'
		output+='<br><a href="/restaurant">Go back Main Page</a>'
		output+='<br>'
		output+=background_pic	
		return output
	else:
		output='<h2>Failed to revoke token for given user.</h2>'
		output+='<br><a href="/restaurant">Go back Main Page</a>'
		output+='<br>'
		output+=background_pic
		return output
